...
fn add_event_handlers(
    ...
    let mut observers = [
        Observer::new(click::handle_focussed_click.pipe(impls::debug_error("handle_click"))),
        Observer::new(drag::handle_dragstart.pipe(impls::debug_error("handle dragstart"))),
